...
def check_all(keys, max_workers=100):
    # Берём случайные 1000 чтобы не проверять все 5000
    if len(keys) > 1000:
        keys = random.sample(keys, 1000)
        print(f"Выбрано случайных ключей для проверки: 1000")
